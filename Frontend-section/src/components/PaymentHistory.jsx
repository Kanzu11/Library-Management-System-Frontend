...
import { FaChevronLeft, FaChevronRight, FaCreditCard, FaCheckCircle, FaClock, FaExclamationTriangle } from "react-icons/fa";
      ...
      <Card className={`${isDark ? "bg-gray-800" : "bg-white"}`}>
        ...
        <CardContent>
          <div className="flex items-center justify-center py-8">
            ...
            <span className={`ml-2 ${isDark ? "text-gray-300" : "text-gray-600"}`}>Loading payment history...</span>
          </div>
        </CardContent>
      </Card>
    );
      ...
      <Card className={`${isDark ? "bg-gray-800" : "bg-white"}`}>
        ...
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className={`text-red-600 ${isDark ? "text-red-400" : "text-red-600"}`}>{error}</p>
          </div>
        </CardContent>
      </Card>
    );
